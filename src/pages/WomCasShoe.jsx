...
export default function WcasShoes(){
  ...
  useEffect(() => {
    ...
    fetch("http://localhost:5000/api/products")
      ...
      .then((data) => {
        ...
        const menFormalItems = data.filter((product) => product.category === "wcas-shoe");
  ...
  return (
    <div className="container my-4">
      <h2 className="text-center mb-4">Women's casual Shoes</h2>
