...
export default function Menformal(){
  ...
  useEffect(() => {
    ...
    fetch("http://localhost:5000/api/products")
      ...
      .then((data) => {
        ...
        const menFormalItems = data.filter((product) => product.category === "men-formal");
  ...
  return (
    <div className="container my-4">
      <h2 className="text-center mb-4">Men's Formal Fashion</h2>
