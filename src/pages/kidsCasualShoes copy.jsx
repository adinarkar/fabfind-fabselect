...
export default function WtradShoes(){
  ...
  useEffect(() => {
    ...
    fetch("http://localhost:5000/api/products")
      ...
      .then((data) => {
        ...
        const menFormalItems = data.filter((product) => product.category === "twf");
  ...
  return (
    <div className="container my-4">
      <h2 className="text-center mb-4">women's traditional shoes</h2>
