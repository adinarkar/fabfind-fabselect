...
export default function MTraditionalshoes(){
  ...
  useEffect(() => {
    ...
    fetch("http://localhost:5000/api/products")
      ...
      .then((data) => {
        ...
        const menFormalItems = data.filter((product) => product.category === "mts");
  ...
  return (
    <div className="container my-4">
      <h2 className="text-center mb-4">Men's traditional shoes</h2>
